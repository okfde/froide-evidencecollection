...
class TestParseLevel:
    @pytest.mark.parametrize(
        "label,expected",
        [
            ("Mitglied des Europäischen Parlaments", "Europa"),
            ("Kandidat für die Europawahl", "Europa"),
            ("Mitglied des Bundestags", "Bund"),
            ("Mitglied des Landtags Bayern", "Land"),
            ("Vorsitzender des Landesverbands Bayern", "Land"),
            ("Mitglied des Kreistags Görlitz", "Kreis"),
            ("Bürgermeister der Stadt Altenberg", "Kreis"),
            ("Mitglied des Gemeinderats Finsing", "Kreis"),
        ],
    )
    ...
    def test_kreis_beats_land_for_landkreis_place_qualifier(self):
        assert (
            parse_level("Vorsitzender des Kreisverbands Landkreis Leipzig") == "Kreis"
        )
